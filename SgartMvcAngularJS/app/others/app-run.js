(function() {	//racchiudo sempre tutto in una 'closure'
  ...
  function run($rootScope, $location, $modal, $cookies, $timeout) {
    ...
    $rootScope.subTitle = 'demo todo list in ASP.NET MVC by sgart.it';
    ...
    /**** css / theme ****/
    $rootScope.cssTable = [
      { value: 'dark', css: '/content/css/bootswatch.1.min.css', title: 'Dark' },
      { value: 'light', css: '/content/css/bootswatch.2.min.css', title: 'Light' }
    ];
    ...
    $rootScope.messages = [];   //{t:0, m=''}
        $rootScope.addMessage = function (t, m, s) {
      var item = null;
      ...
      if (typeof t === "object")
        item = t;
            ...
            if (t === "E" || t === "W") {
                console.log("$rootScope.addMessage", item.t, item.m);
            }
